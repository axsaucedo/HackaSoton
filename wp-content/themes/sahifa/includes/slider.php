	...
	<div id="ei-slider" class="ei-slider">
		...
		<?php $i= 0;
			...
			<?php if ( function_exists("has_post_thumbnail") && has_post_thumbnail() ) : ?>
				<img src="<?php echo tie_thumb_src('', $width , $height ); ?>"  alt="<?php the_title(); ?>" />
			<?php endif; ?>
				<div class="ei-title">
		...
		<?php $i= 0;
			while ( $featured_query->have_posts() ) : $featured_query->the_post(); $i++; ?>
			<li><a href="#">Slide <?php echo $i; ?></a><img src="<?php echo tie_thumb_src('',272,125); ?>" alt="<?php the_title(); ?>" /></li>
    		<?php endwhile;?>
		</ul><!-- ei-slider-thumbs -->
	</div>
	<?php endif; ?>
<?php else: ?>
	...
	<div id="ei-slider" class="ei-slider">
		...
		<?php $i= 0;
			...
			<li>
				<img src="<?php echo tie_slider_img_src( $slide['id'] , $width , $height ) ?>" alt="<?php  echo stripslashes( $slide['title'] )  ?>" />
		 ...
		 <ul class="ei-slider-thumbs">
			...
			<li><a href="#">Slide <?php echo $i; ?></a><img src="<?php echo tie_slider_img_src($slide['id'] ,272,125); ?>" alt="<?php  echo stripslashes( $slide['title'] )  ?>" /></li>
			<?php endforeach; ?>
